        ...
        authApi.signUp(loginData)
            .then(res => {
                if (res.data.status === "success") {
                    setSuccessMessage(t('check_email_signup'))
                    resetForm();
            ...
            <div className='container'>
                <div className="row">
                    <div className="col s12 l8 offset-l2 center-align white-text">
                        ...
                        {successMessage && <div className="material-alert success">
                            {successMessage}
                        </div>}
                            ...
                            <div className="card-content">
                                ...
                                >
                                    {({ errors, touched, handleSubmit, handleBlur }) => (
                                        <Form onSubmit={e => handleSubmit(e)} onChange={(() => setErrorMessage(null), () => setSuccessMessage(null))}>
                                            <div className="row">
