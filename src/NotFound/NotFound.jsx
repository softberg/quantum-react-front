...
const NotFound = () => {
	return <>
		<main className="grey lighten">
			<div className="container">
				<div className="row center-align white-text">
					<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="206.5px"
						viewBox="0 0 326.5 500" style={{ enableBackground: 'new 0 0 326.5 500' }} xmlSpace="preserve">
						<g id="robot_1_">
					...
					<h1>404</h1>
					<h3>ERROR PAGE</h3>
					<Link className="white-text" to="/">Back to Home</Link>
				</div>
			</div>
		</main>
	</>
